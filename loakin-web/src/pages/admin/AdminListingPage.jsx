        ...
        <div style={styles.filterCard}>
          <form onSubmit={handleSearch} style={styles.filterForm}>
            ...
            >
              ...
              <option value="1">â­ Unggulan</option>
                  ...
                  return (
                    <tr key={listing.id} style={styles.tr}>
                        ...
                        <div style={styles.listingCell}>
                          <div style={styles.listingPhoto}>
                            {getPhotoUrl(listing.primary_photo) ? (
                              ...
                              <div style={styles.noPhoto}>ðŸ“·</div>
                            )}
                          </div>
                          <div>
                            <Link
                      ...
                      <td style={styles.td}>
                        ...
                        >
                          {listing.is_featured ? 'â­ Unggulan' : 'â˜† Biasa'}
                        </button>
                      </td>
                        ...
                        <div style={styles.actions}>
                          {listing.status === 'pending_review' && (
                            <>
                              ...
                              >
                                {actionLoading === listing.id + '-approve' ? '...' : 'âœ… Setujui'}
                              </button>
                              <button
                              ...
                              >
                                {actionLoading === listing.id + '-reject' ? '...' : 'âŒ Tolak'}
                              </button>
                            </>
                          )}
                          <button
